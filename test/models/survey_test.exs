defmodule Ask.SurveyTest do
  ...
  @valid_attrs %{name: "some content", schedule_start_time: ~T[09:00:00], schedule_end_time: ~T[18:00:00], timezone: "UTC"}
  @invalid_attrs %{}
  ...
  describe "next_available_date_time" do
    @survey %Survey{
      schedule_start_time: ~T[09:00:00],
      schedule_end_time: ~T[18:00:00],
